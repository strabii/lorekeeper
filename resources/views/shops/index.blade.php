...
@section('shops-content')
    ...
    <div class="row shops-row">
        ...
        <div class="col-md-3 col-6 mb-3 text-center">
            <div class="shop-image">
                <a href="{{ $adoptions->url }}"><img src="{{ $adoptions->adoptionImageUrl ? $adoption->adoptionImageUrl : asset('images/characters.png') }}" alt="{{ $adoptions->name }}" /></a>
            </div>
            <div class="shop-name mt-1">
                <a href="{{ $adoptions->url }}" class="h5 mb-0">
                    {{ $adoptions->name }}
                </a>
            </div>
        </div>
